...
function GlobalFilter({
  ...
  return (
    <Col sm={4}>
      <div className="search-box me-2 mx-2 mb-2 d-inline-block">
        <div className="position-relative" style={{ marginLeft: '40px' }}>
            ...
            {headerGroups.map((headerGroup) => (
              <tr key={headerGroup.id} {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map((column) => (
                  <th key={column.id} style={{ backgroundColor: '#b58ee4' }}>
